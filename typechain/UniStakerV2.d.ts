...
interface UniStakerV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "getNumRewardCalcTemplates()": FunctionFragment;
    ...
    "renounceAdminship()": FunctionFragment;
    ...
    "setLMRewardMultiplier(string,uint256,uint256)": FunctionFragment;
    ...
    "stakeERC721(address,address,address,uint256,bytes)": FunctionFragment;
    "stakedTokenTotal(address)": FunctionFragment;
    "startLMRewards(address,uint256,uint256,string)": FunctionFragment;
    "transferAdminship(address)": FunctionFragment;
    "unstakeERC721AndClaimReward(address,address,address,address,uint256,bool,bytes)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getNumRewardCalcTemplates",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "renounceAdminship",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setLMRewardMultiplier",
  ...
  encodeFunctionData(
    functionFragment: "transferAdminship",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "unstakeERC721AndClaimReward",
  ...
  events: {
    "AdminshipTransferred(address,address)": EventFragment;
    ...
    "UniStakerV2Created(address,address)": EventFragment;
    "UniStakerV2Funded(address,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "AdminshipTransferred"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "UniStakerV2Created"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "UniStakerV2Funded"): EventFragment;
...
export class UniStakerV2 extends Contract {
  ...
  interface: UniStakerV2Interface;
  ...
  functions: {
    ...
    "setLMRewardMultiplier(string,uint256,uint256)"(
      tier: string,
      numerator: BigNumberish,
      denominator: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ...
    "stakeERC721(address,address,address,uint256,bytes)"(
      vault: string,
      vaultFactory: string,
      token: string,
      tokenId: BigNumberish,
    ...
    "unstakeERC721AndClaimReward(address,address,address,address,uint256,bool,bytes)"(
      vault: string,
      vaultFactory: string,
      recipient: string,
      token: string,
  ...
  getNumRewardCalcTemplates(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  callStatic: {
    ...
    renounceAdminship(overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    Staked(
      ...
      { vault: string; token: string; tokenId: BigNumber }
    >;
